...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  if ($result) {
    if (mysqli_num_rows($result) > 0) {
      ...
      $_SESSION['logon_email'] = $email;
      header("Location: manual_signup.php?e=" . $eval);
    }
  } else {
  ...
  <body>
    <center>
      ...
      <form method="post">
        ...
        or<br><br>
        <div class="d-grid gap-2">
          <a href="login_google_educator.php" class="btn btn-secondary">
          ...
          <a class="btn btn-danger" href="login.php">Back</a><br>
        </div>
      </form>
    </center>
  </body>
